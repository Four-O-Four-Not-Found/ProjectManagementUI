    ...
    <div 
      ...
      className={twMerge(
        ...
        notification.isRead 
          ...
          : "bg-[var(--card-bg)] border-[var(--card-border)] hover:bg-[var(--card-bg)] shadow-sm shadow-black/20"
      )}
    >
      {!notification.isRead && (
      ...
      <div className="flex gap-4">
        <div className={twMerge(
          ...
          notification.type === 'TaskAssigned' ? 'bg-accent-primary/10 text-accent-primary' :
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start mb-1">
            ...
            <span className="text-[9px] text-text-muted uppercase font-bold shrink-0">
